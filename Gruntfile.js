...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    babel: {
      ...
      dist: {
        files: {
          'build/cannon.babel.js': bundlePath
        }
      }
    },
  ...
  grunt.registerTask(
    'addDate',
    'Adds the current date to the top of the built files',
    function() {
  ...
  grunt.registerTask(
    'addLicense',
    'Adds the LICENSE to the top of the built files',
    function() {
  ...
  grunt.registerTask(
    'requireJsFix',
    'Modifies the browserify bundle so it works with RequireJS',
    function() {
